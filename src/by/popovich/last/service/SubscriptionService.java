...
public interface SubscriptionService extends Service {
    ...
    void add(Subscription subscription) throws PersistentException;

    void update(Subscription subscription) throws PersistentException;

    void delete(Integer identity, Integer groupId) throws PersistentException;
