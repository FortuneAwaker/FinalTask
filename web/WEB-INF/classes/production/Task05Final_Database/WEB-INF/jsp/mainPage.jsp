    ...
    <div class="post">
        ...
        <div class="post_description">
            <h4>В любом деле самое главное - это начать. Ведь когда сделан
                первый шаг,
                все последующие шаги даются уже гораздо проще, ведь появляется
                уверенность в себе и в своих силах.
                Да, в голове возникают вопросы как зачем мне это нужно, не стоит
                ли мне сейчас бросить и заниматься другими
                делами. Но ты осознаёшь, что рах уже начал что-то стоящее, то
